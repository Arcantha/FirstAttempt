...
import com.arcantha.avatar.items.ItemBase;
import com.arcantha.avatar.items.armor.ArmorBase;
...
public class ModItems {
	...
	//Materials
	public static final ArmorMaterial ARMOR_MATERIAL_LOREYU = EnumHelper.addArmorMaterial("armor_material_loreyu", Reference.MOD_ID + ":loreyu_leaf", 10, 
